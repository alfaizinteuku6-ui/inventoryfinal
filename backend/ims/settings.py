...
CSRF_TRUSTED_ORIGINS = config(
    ...
    default='http://localhost:8000,http://localhost:5173,http://localhost,http://127.0.0.1,http://2.27.165.72',
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # This should point to backend/static
]
